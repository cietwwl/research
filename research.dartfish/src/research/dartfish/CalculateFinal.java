...
public class CalculateFinal
{
	...
	public void process(String inFileName, String outFileName) throws IOException
	{
		...
		try
		{
	        ...
	        Pair<Double, Integer> begin = CsvUtils.findValueInColumn(csvIn, "wristSpeed", -1,
	        ...
	        Pair<Double, Integer> mid = CsvUtils.findValueInColumn(csvIn, "wristSpeed", begin.second,
